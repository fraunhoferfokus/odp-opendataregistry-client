...
public class QueryFacetItemImpl implements QueryFacetItem, Serializable {
     ...
     * (non-Javadoc)
     * 
     * @see de.fhg.fokus.odp.registry.queries.QueryFacetItem#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see de.fhg.fokus.odp.registry.queries.QueryFacetItem#getDisplayName()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see de.fhg.fokus.odp.registry.queries.QueryFacetItem#getCount()
     */
    @Override
    public int getCount() {
